...
public class OrderDetailByTableResDTO {
    ...
    public OrderDetailByTableResDTO(Long orderDetailId, Long productId, String title, BigDecimal price, Integer quantity, BigDecimal amount, String unit, String note, ProductAvatar avatar) {
