...
@Getter
@Setter
public class OrderCreReqDTO implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return OrderCreReqDTO.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        OrderCreReqDTO orderCreReqDTO = (OrderCreReqDTO) target;

        String tableIdStr = orderCreReqDTO.tableId;
        String quantityStr = orderCreReqDTO.quantity;
        String productIdStr = orderCreReqDTO.productId;
        String note = orderCreReqDTO.note;
